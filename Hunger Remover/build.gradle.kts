...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(478201, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Hunger Remover"
...
modrinth {
    ...
    projectId.set("hunger-remover")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Hunger Remover")
    dependencies {
